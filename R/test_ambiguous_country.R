...
test_ambiguous_country <- function (f = system.file("extdata/reg2country.csv", package = "bibliographica")) {
  ...
  map <- read_mapping(f, mode = "table", sep = ";", sort = TRUE, self.match = FALSE, include.lowercase = FALSE, ignore.empty = FALSE, remove.ambiguous = FALSE, lowercase = FALSE, from = "region", to = "country")
