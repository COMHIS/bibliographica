...
`r length(readLines(paste0(this.folder, "/output.tables/authors_missing_lifeyears.csv")))-1` [authors with missing life years](output.tables/authors_missing_lifeyears.csv) (Life year info can be augmented [here](https://github.com/COMHIS/bibliographica/blob/master/inst/extdata/author_info.csv))
...
```{r, summaryauthorslife, echo=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=6}
...
```{r author_age, fig.height=7, fig.width=22, echo=FALSE, message=FALSE, warning=FALSE}
