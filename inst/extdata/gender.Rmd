...
[First names classified as female](output.tables/gender_female.csv)

[First names classified as male](output.tables/gender_male.csv)

[First names with unresolved gender](output.tables/gender_unknown.csv)

[Authors with unresolved gender](output.tables/author_gender_discarded.csv)

[Author-gender mappings](output.tables/author_gender_conversion_nontrivial.csv) in the complete data
