 ...
 * `r nrow(subset(df.preprocessed, author_gender == "ambiguous" | is.na(author_gender)))` documents (`r round(100*nrow(subset(df.preprocessed, author_gender == "ambiguous"))/nrow(df.preprocessed), 1)`) with [unresolved gender](output.tables/author_gender_discarded.csv)
