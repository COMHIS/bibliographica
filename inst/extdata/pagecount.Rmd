...
mean.pagecounts <- get_mean_pagecounts(df)
```

```{r size-pagecountsmulti2, echo=FALSE, message=FALSE, warning=FALSE, fig.width=20, fig.height=5}
theme_set(theme_bw(20))
dfs <- NULL
