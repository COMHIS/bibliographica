 ...
 * `r length(readLines(paste0(this.folder, "/output.tables/publication_place_missingcountry.csv"))) - 1` [places with unknown publication country](output.tables/publication_place_missingcountry.csv) (can be added to [country mappings](https://github.com/COMHIS/bibliographica/blob/master/inst/extdata/reg2country.csv))
