...
## Page counts
  ...
  * Page count missing and estimated for `r sum(!is.na(df$pagecount)) - sum(!is.na(df$pagecount.orig))` documents (`r (sum(!is.na(df$pagecount)) - sum(!is.na(df$pagecount.orig)))/nrow(df)`%).
...
```{r size-estimated, echo=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=8}
...
```{r size-summary, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=5}
...
```{r size-comp, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=7}
...
```{r size-pagecomp, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=7}
...
```{r size-validation, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=7}
...
```{r size-compbyformat, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=7, fig.show="hold", out.width="430px"}
