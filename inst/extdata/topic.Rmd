...
```
  ...
  * `r length(unique(df$subject_topic))` unique subject topics
  * `r sum(!is.na(df$subject_topic))` documents assigned to at least one subject topic (`r round(100*mean(!is.na(df$subject_topic)))`)
