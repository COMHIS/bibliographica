...
/usr/local/bin/R CMD check bibliographica_0.1.40.tar.gz --no-build-vignettes --no-tests #--no-examples 
/usr/local/bin/R CMD INSTALL bibliographica_0.1.40.tar.gz
