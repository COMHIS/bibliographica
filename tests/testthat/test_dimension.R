...
test_that("fennica dimensions", {
  ...
  expect_equal(as.character(polish_dimensions("16to[7.5x5.5 cm].")$gatherings), 16mo)
    expect_equal(as.character(polish_dimensions("16to[7.5x5.5 cm].")$length), 7.5)
  ...
  expect_equal(as.character(polish_dimensions("8to(18 cm)")$length), 18)  
  ...
  expect_equal(as.character(polish_dimensions("4to(21 x 26 cm)")$length), 21)
  expect_equal(as.character(polish_dimensions("4to(21 x 26 cm)")$width), 26)    
  ...
  expect_true(is.na(polish_dimensions("o.")$gatherings))
  expect_true(is.na(polish_dimensions("[?to.")$gatherings))
  expect_true(is.na(polish_dimensions("?to")$gatherings))
  expect_true(is.na(polish_dimensions("Koko vaihtelee.")$gatherings))
  expect_true(is.na(polish_dimensions("20.")$gatherings))
  expect_true(is.na(polish_dimensions("1915.")$gatherings))      
