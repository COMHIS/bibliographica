...
test_that("page count is correct", {
  ...
  expect_equal(sum(polish_pages("[2],iii,[1],25,[26],50-69,[1];213,[67]p.,plates")$estimated.pages[[1]]), 354)
  ...
  expect_equal(sum(polish_pages("[14],356,361-408;76,79-216,[14]p.,plates")$estimated.pages[[1]]), 655)
