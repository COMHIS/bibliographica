...
test_that("page count is correct", {
  ...
  expect_equal(sum(polish_pages("[4],56,65-176;45,[1]p.")$estimated.pages[[1]]), 226)
  ...
  expect_equal(polish_pages("[4], 31, 28-138, [2] p.")$estimated.pages[[1]], 144)
  expect_equal(polish_pages("[3], 4-8, p. 7, 10-11, 10-13, [1] p.")$estimated.pages[[1]], 17)
  expect_equal(polish_pages("[2] 6 p.")$estimated.pages[[1]], 8)
  ...
  is_identical_to(polish_pages("[fewer than 50 pages]")$estimated.pages[[1]], NA)
  ...
  expect_equal(sum(polish_pages("[2],iii,[1],25,[26],50-69,[1];213,[67]p.,plates")$estimated.pages[[1]]), 386)
  ...
  expect_equal(polish_pages("[8],xvi,111,[46],114-314,[6]p.,table")$estimated.pages[[1]], 392)
  expect_equal(polish_pages("[4],vii-xii,[4],222p.,plates")$estimated.pages[[1]], 240)
  expect_equal(sum(polish_pages("[14],356,361-408;76,79-216,[14]p.,plates")$estimated.pages[[1]]), 656)
  ...
  expect_equal(sum(polish_pages("[2],99,[4],102-110,113-119,[1],119-120,[2];[2],121-246p.,tables")$estimated.pages[[1]]), 261)
  ...
  expect_equal(polish_pages("xxxii [i.e. xxxiii] leaves")$estimated.pages[[1]], 66) 
  expect_equal(polish_pages("5-49 i.e 5-51]")$estimated.pages[[1]], 47) 
  expect_equal(polish_pages("324[i.e.325]plates")$estimated.pages[[1]], 650) 
  ...
  expect_equal(polish_pages("6 p. [i.e.3 leaves] ;")$estimated.pages[[1]], 6) 
  expect_equal(polish_pages("2 [i.e. 4] leaves")$estimated.pages[[1]], 8) 
