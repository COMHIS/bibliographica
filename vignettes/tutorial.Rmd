...
Here a few examples, for a full list of available functions, see the [function documentation](https://github.com/rOpenGov/bibliographica/blob/master/man/)- We also provide some [ready-made stopword lists](https://github.com/rOpenGov/bibliographica/tree/master/inst/extdata).

This example removes the term "well" and individual letters from the input vector:
